...
KISSY.add( function( S, Event, Node, Dom, IO, Sizzle, FormViwe ) {
    var $ = S.Node.all,
        E = S.Event,
        D = S.DOM,
        UA = S.UA,
    ...
    S.augment( Modle, {
        ...
        _init: function( element, config, regexp ) {
            ...
            self._viwe = new FormViwe( element, self.config, self.reg );
    ...
    requires: [ 'event', 'node', 'dom', 'ajax', 'sizzle', './formViwe' ]
});